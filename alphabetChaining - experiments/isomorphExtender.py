...
extras = {"A.BA..B": (3,2),
              ...
              "A.B....A..B..A": (2,2),
              "A..BC.D....AB.......DC": (6,6),
              "AB..C...A.DEF.BF.DB.EC": (5,4),
              "A.....BCD.ED.BE.CAF....F": (5,5),
              "A.....BCD.ED.BE.CA..F....F": (8,8),
              "A..BAC........B..DE.F....E.DF.C": (8,8),
              "ABC..D...D......E.A...F...FB.EC.F": (7,8)}


for iso in isoSeqs.keys():
    s=[]
    extra1 = 0
    extra2 = 0
    ...
    extras = {"A.BA..B": (3,2),
              ...
              "A.B....A..B..A": (3,7),
              "A..BC.D....AB.......DC": (32,32),
              "AB..C...A.DEF.BF.DB.EC": (6,4),
              "A.....BCD.ED.BE.CAF....F": (5,6),
              "A.....BCD.ED.BE.CA..F....F": (9,13),
              "A..BAC........B..DE.F....E.DF.C": (9,12),
              "ABC..D...D......E.A...F...FB.EC.F": (7,17)}

    if iso in extras.keys():
        extra1, extra2 = extras[iso]
    
    
    for m, pos, tris in isoSeqs[iso]:
        n = messages[m][pos-extra1 : pos+len(iso)+extra2]
        if not n in s:
            s.append((m,pos,n))
    isoSeqs2[iso] = s
    
with open("isomorphs_extended.json","w") as f:
    json.dump(isoSeqs2, f)
