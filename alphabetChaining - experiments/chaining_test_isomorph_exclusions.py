...
badIsomorphs = ["AB......A.C.D.BD.CB", "A...A......B.....C...C..B", "AB...C...C......D.A...E...EB.D"] #literally never work in chaining, last one sometimes works
...
for ignoreLength in range(1, len(atomicChains)-1, 1):
